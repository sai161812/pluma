...
new_func = '''def test_soak_1000_fast_tasks_no_memory_leak() -> None:
...
code = replace_body('test_soak_1000_fast_tasks_no_memory_leak', new_func, code)

with open('tests/benchmarks/test_memory_soak.py', 'w', encoding='utf-8') as f:
    f.write(code)
print("Soak test replaced")
