...
replacement = '''class TestGoldenCorpusContract:
    ...
    def test_golden_corpus_entries_pass_policy_and_normalization(self) -> None:
        ...
        assert len(_GOLDEN_COMMANDS) == 125, f"Expected 125 golden commands, got {len(_GOLDEN_COMMANDS)}"
        
        for entry in _GOLDEN_COMMANDS:
...
code = re.sub(
    r'class TestGoldenCorpusContract:.*?# ===========================================================================\n# 10\. Soak Resource Containment',
    replacement + '\n\n# ===========================================================================\n# 10. Soak Resource Containment',
    code,
    flags=re.DOTALL
)
...
with open('tests/unit/test_phase135_adversarial.py', 'w', encoding='utf-8') as f:
    f.write(code)
print('Adversarial tests updated')
